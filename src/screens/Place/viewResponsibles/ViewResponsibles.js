...
class ViewResponsibles extends React.Component {
  ...
  addResponsibles = () => {
    const placeId = this.props.match.params.id;
    this.service
      .addResponsibles(placeId, this.state.user.id)
      .then((Response) => {
        this.find(placeId);
  ...
  find = (placeId) => {
    console.log(
      "🚀 ~ file: ViewResponsibles.js:51 ~ ViewResponsibles ~ placeId:",
      placeId
    );
    this.service
      ...
      .then((Response) => {
        console.log(
          "🚀 ~ file: ViewResponsibles.js:54 ~ ViewResponsibles ~ Response:",
          Response.data
        );
      ...
      .catch((error) => {
        console.log(
          "🚀 ~ file: ViewResponsibles.js:63 ~ ViewResponsibles ~ error:",
          error.data
        );
        console.log(error);
      });
        ...
        <header className="App-header">
          ...
          <fieldset className="field-viewResponsibles">
            ...
            <div className="table-all">
              <UsersTable
                user={this.state.responsibles}
                delete={this.removeResponsibles}
              />
            </div>
            <div className="cont-resp">
              <FormGroup className="filterUserResponsibles">
                ...
                <button
                  className="btn btn-primary btn-res"
                  onClick={this.addResponsibles}
                >
